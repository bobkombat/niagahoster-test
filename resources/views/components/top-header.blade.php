<div class="container d-flex justify-content-between top-header">
    <div class="d-flex">
        ...
        <p class="p-1">Gratis Ebook 9 Cara Cerdas Menggunakan Domain [ x ]</p>
    </div>
    <div class="d-flex align-items-center text-center p-1">
        <div class="d-flex align-items-center">
            <svg width="1.25em" height="1.25em" viewBox="0 0 16 16" class="bi bi-telephone-fill text-tri" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M2.267.98a1.636 1.636 0 0 1 2.448.152l1.681 2.162c.309.396.418.913.296 1.4l-.513 2.053a.636.636 0 0 0 .167.604L8.65 9.654a.636.636 0 0 0 .604.167l2.052-.513a1.636 1.636 0 0 1 1.401.296l2.162 1.681c.777.604.849 1.753.153 2.448l-.97.97c-.693.693-1.73.998-2.697.658a17.47 17.47 0 0 1-6.571-4.144A17.47 17.47 0 0 1 .639 4.646c-.34-.967-.035-2.004.658-2.698l.97-.969z"/>
            </svg>
            <p class="p-2">0274-5305505</p>
        </div>
        <div class="d-flex align-items-center ml-2">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chat-left-text-fill text-tri" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="p-2">Live Chat</p>
        </div>
        <div class="d-flex align-items-center ml-2">
            <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-person-circle text-tri" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 0 0 8 15a6.987 6.987 0 0 0 5.468-2.63z"/>
                <path fill-rule="evenodd" d="M8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/>
            </svg>
            <p class="p-2">Member Area</p>
        </div>
    </div>
</div>